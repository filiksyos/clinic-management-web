  ...
  return (
    <>
      <Meta
        ...
        description="This is the details of patient list page of Medico where receptionist can view details of patient and more."
      />
      ...
      <div className="mx-8">
        <div className="flex items-center justify-between mt-2">
          ...
          <div className="flex items-center gap-1 text-[#495057] text-sm">
            ...
            <Link href="/receptionist/patients">Patient</Link>
            <BsSlash className="text-[#ccc]" />
            ...
            <div>
              <div className="w-full mt-10 lg:mt-14 mx-auto flex justify-center items-center bg-white rounded-lg">
                <div>
                  ...
                  <div className="my-5">
                    <Link
                      href={`/receptionist/patients/${params.id}/edit`}
