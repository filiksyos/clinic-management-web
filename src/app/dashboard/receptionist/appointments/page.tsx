    ...
    <div className="mx-5">
      <div className="flex items-center justify-between mt-2">
        ...
        <div className="flex items-center gap-1 text-gray-600 text-sm">
          ...
          <Link href="/dashboard/receptionist/appointments/">Appointments</Link>
        </div>
      </div>
      
      <div className="mt-5">
        <Link
          href="/dashboard/receptionist/appointments/create"
                    ...
                    <tr key={appointment.id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        <div className="flex gap-2">
                          ...
                          <Link
                            href={`/dashboard/receptionist/appointments/${appointment.id}/edit`}
                            className="flex items-center justify-center h-8 w-8 bg-blue-600 hover:bg-blue-700 text-white rounded-full"
                          >
                            <FaEdit size={14} />
                          </Link>
                          <Link
                            href={`/dashboard/receptionist/appointments/${appointment.id}`}
