...
export default function DoctorCreatePatientPage() { // Renamed component
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push("/doctor/dashboard/patients"); // Redirect to doctor patient list
    } catch (error) {
